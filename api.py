...
class BookList(Resource):
    def __init__(self):
        ...
        self.reqparse.add_argument(
            "name", type=str, required=True, help="The name of the book must be provided", location="json")
        self.reqparse.add_argument(
            "author", type=str, required=True, help="The author of the book must be provided", location="json")
        self.reqparse.add_argument(
            "abstract", type=str, required=True, help="The abstract of the book must be provided", location="json")
